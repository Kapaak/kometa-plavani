...
const NavItems = () => {
  ...
  return (
    <S.NavLinks isActive={isActive}>
      <NavLink href="/" scrollTarget="home">Domů</NavLink>
      <NavLink href="/" scrollTarget="about">O nás</NavLink>
      <NavLink href="/prihlasky" scrollTarget="application">Přihlášky</NavLink>
